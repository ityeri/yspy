...
class Suggestion:
    ...
    @staticmethod
    def get(query: str, locale: Locale = NONE_LOCALE, *, client: Client | None = None) -> Suggestion:
    ...
    @staticmethod
    async def aget(query: str, locale: Locale = NONE_LOCALE, *, client: AsyncClient | None = None) -> Suggestion:
    ...
    @staticmethod
    def from_suggestion_data(suggestion_data: SuggestionData, locale: Locale = NONE_LOCALE) -> Suggestion:
        return Suggestion(
