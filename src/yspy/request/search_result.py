...
class SearchResultRequest:
    ...
    def get_first_page(
        ...
        with optional_sync_client(client) as client:
            return SearchResultRequest.build_first_page_request(query, search_mode, locale).send_sync_request(client)
    ...
    async def aget_first_page(
        ...
        async with optional_async_client(client) as client:
            return await SearchResultRequest.build_first_page_request(query, search_mode, locale)\
    ...
    def get_continuation_page(
        ...
        with optional_sync_client(client) as client:
            return SearchResultRequest.build_continuation_page_request(continuation_token, search_mode, locale)\
    ...
    async def aget_continuation_page(
        ...
        async with optional_async_client(client) as client:
            return await SearchResultRequest.build_continuation_page_request(continuation_token, search_mode, locale)\
                .send_async_request(client)
